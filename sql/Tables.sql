...
CREATE TABLE USERS_PASSWORDS(
	...
	CONSTRAINT FK_USER_ID_PASSWORD FOREIGN KEY (USER_ID) REFERENCES USERS(USER_ID)
) tablespace users;
CREATE TABLE USERS_ADDRESSES(
	...
	CONSTRAINT FK_USER_ID_ADDRESSES FOREIGN KEY (USER_ID) REFERENCES USERS(USER_ID)
) tablespace users;
CREATE TABLE ORDERS(
...
CREATE TABLE ORDERS_PRODUCTS(
	...
	CONSTRAINT FK_ORDER_ID_ORDERS_PRODUCTS FOREIGN KEY (ORDER_ID) REFERENCES ORDERS(ORDER_ID),
...
CREATE TABLE PRODUCT_COMMENTS(
	...
	CONSTRAINT FK_PRODUCT_ID_PRODUCT_COMMENT FOREIGN KEY (PRODUCT_ID) REFERENCES PRODUCTS(PRODUCT_ID)
) tablespace products;
CREATE TABLE BASKET(
	...
	CONSTRAINT FK_USER_ID_BASKET FOREIGN KEY (USER_ID) REFERENCES USERS(USER_ID),
	CONSTRAINT FK_PRODUCT_ID_BASKET FOREIGN KEY (PRODUCT_ID) REFERENCES PRODUCTS(PRODUCT_ID)
) tablespace users;
CREATE TABLE FAVORITES(
	BASKET_ID SERIAL PRIMARY KEY,
	PRODUCT_ID INTEGER NOT NULL,
	USER_ID INTEGER NOT NULL,
	CONSTRAINT FK_USER_ID_FAVORITES FOREIGN KEY (USER_ID) REFERENCES USERS(USER_ID),
